        ...
        for nondominated_idx in all_nondominated_idx:
            if len(iter_pond_RS) == self.pop_size:
                ...
                if hf1_max != hf1_min and hf2_max != hf2_min:
                    comb_normal_nondomin_fit_list = [alpha*(fitness1-hf1_min)/(hf1_max-hf1_min)+beta*(fitness2-hf2_min)/(hf2_max-hf2_min)
                    ...
                    comb_normal_nondomin_fit_list = [beta*(fitness2 - hf2_min)/(hf2_max - hf2_min)
                                                     for fitness2 in nondominated_fitness_list2]
                elif hf1_max != hf1_min and hf2_max == hf2_min:
                    comb_normal_nondomin_fit_list = [alpha*(fitness1-hf1_min)/(hf1_max-hf1_min)
