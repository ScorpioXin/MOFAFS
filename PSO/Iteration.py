...
def iteration(now_scheduling_cout, hunger_data):
    ...
    path1 = f'../FitnessData/dynamic16/nsga/scheduling{str(now_scheduling_cout)}_{str(seed_num)}.xlsx'
...
def main():
    ...
    for now_scheduling_cout in range(1, len(all_hunger_data)+1):
        ...
        path1 = f'../SchedulingData/dynamic16/nsga/scheduling{str(now_scheduling_cout)}_{str(seed_num)}.xlsx'
